...
const lenis = new Lenis({
    duration: 1.2, // Optimized for responsive and smooth scrolling
...
// Force engine to top on complete load
window.onload = () => {
...
function scaleImage(img, ctx) {
    ...
    // Math.floor prevents sub-pixel rendering which causes severe lag on scroll
...
if (canvas3) {
    ...
    const currentFrame3 = index => `animites_000/animites_${index.toString().padStart(3, '0')}.jpg`;
...
document.addEventListener('mousemove', (e) => {
    ...
    document.querySelectorAll('.tilt-card').forEach(card => {
        ...
        // Tilt Logic (Disabled as per request)
        /*
